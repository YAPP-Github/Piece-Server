...
public class BlockRepairController {
  ...
  @PostMapping
  @Operation(summary = "블룸 필터 복구", description = "REDIS 장애나 마이그레이션 상황에 쓰는 필터 복구 API 입니다.", tags = {
      "차단"})
  @ApiResponse(responseCode = "200", description = "복구 성공")
  public ResponseEntity<CommonResponse<Void>> repairBlock(@AuthenticationPrincipal Long userId) {
    blockRepairService.repairBloomBlockById(userId);
    blockRepairService.repairBloomBlockByContacts(userId);
